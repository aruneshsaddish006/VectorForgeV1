...
from vectorforge_v1.llm_gateway import DEFAULT_AUTOGLUON_AI_GATEWAY_MODEL
...
class Settings(BaseSettings):
    ...
    planner_provider: Literal["mock", "openai", "ai_gateway"] = "ai_gateway"
    ai_gateway_model: str = Field(
        default=DEFAULT_AUTOGLUON_AI_GATEWAY_MODEL,
        validation_alias=AliasChoices(
            "VECTORFORGE_AUTOGLUON_AI_GATEWAY_MODEL",
            "AUTOGLUON_AI_GATEWAY_MODEL",

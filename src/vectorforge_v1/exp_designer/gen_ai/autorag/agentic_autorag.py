...
def g_eval_metric_for_goal(optimize_for: str) -> dict[str, Any]:
    ...
    return {
        ...
        "model": os.environ.get("AUTORAG_AGENT_GEVAL_MODEL", os.environ.get("AUTORAG_AGENT_MODEL", DEFAULT_GEVAL_MODEL)),
...
def fallback_plan(profile: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "rag": {
            ...
            "generator_model": DEFAULT_RAG_MODEL,
        },
    }
...
def validate_plan(plan: dict[str, Any], profile: dict[str, Any]) -> dict[str, Any]:
    ...
    rag.setdefault("embedding_model", DEFAULT_EMBEDDING_MODEL)
    rag.setdefault("generator_model", DEFAULT_RAG_MODEL)
    return plan
...
- embedding_model: use {DEFAULT_EMBEDDING_MODEL}
- generator_model: use {os.environ.get("AUTORAG_AGENT_MODEL", DEFAULT_RAG_MODEL)}
        ...
        architectures.append(
            {
                ...
                "generator_metrics": generator_metrics,
                "primary_metric": primary_metric,
                "embedding_model": arch.get("embedding_model", DEFAULT_EMBEDDING_MODEL),
                "generator_model": arch.get("generator_model", os.environ.get("AUTORAG_AGENT_MODEL", DEFAULT_RAG_MODEL)),
            }
        )
...
def create_qa(state: AgentState) -> AgentState:
    ...
    qa = (
        ...
        .batch_apply(factoid_query_gen, client=client, model_name=os.environ.get("AUTORAG_AGENT_MODEL", DEFAULT_RAG_MODEL), lang="en")
        .batch_apply(make_concise_gen_gt, client=client, model_name=os.environ.get("AUTORAG_AGENT_MODEL", DEFAULT_RAG_MODEL), lang="en")
